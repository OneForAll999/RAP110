...
define view entity ZRAP110_R_BOOKINGTP_02A
  as select from ZRAP110_ABOOK02A as Booking
  association to parent ZRAP110_R_TRAVELTP_02A as _Travel on $projection.TravelID = _Travel.TravelID
